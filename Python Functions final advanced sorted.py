...
def load_movies_data():
    ...
    #display movies
    #(F1. load_movies_data) stands for the first function and for its name. It should help the reader finding the matching results of the specific function in the output box.
...
#Therefore, some basic functions for liking (F1.3), sharing (F1.4) and rating (F1.5) movies need to be on the top (due to the high number of simulations, the print-functions get commented out during the data-creation for a better readability.):
...
def like_a_movie_without_printing(movie_id, user_id):
  ...
  #print("(F1.3 like_a_movie(movie_id, user_id)) " +user["name"].values.item() +" gives "+movie_user_watched["name"].values.item() + " a like.")
  ...
  #commented out for data-creation:
  #print("\n(F1.3 like_a_movie(movie_id, user_id)) These are the updated data: \n")
...
def share_a_movie_without_printing(movie_id):
  ...
  #print("\n(F1.4 share_a_movie(movie_id, user_id)) These are the updated data: \n")
  #print(movie_user_watched[["name","rate","likes","shares","views"]])
...
def rate_a_movie_without_printing(movie_id, rating):
  ...
  #commented out for data-creation:
  #print()
  #print("(F1.5 rate_a_movie(movie_id, rating))) Someone gives "+movie_user_watched["name"].values.item() + " a rating of " + str(rating) +".")

  #commented out for data-creation:
  #print("\n(F1.5 rate_a_movie(movie_id, rating)) This is the movies current status:\n")
  ...
  #for index, row in movies_df[movies_df["_id"] ==movie_id].iterrows():
    #print("\n(F1.5 rate_a_movie(movie_id, rating)) This is the movies new status:\n")
...
def watch_a_movie_without_printing(movie_id, user_id, time_period, likes, rating, shares):
  ...
  #commented out for data-creation:
  #print("(F1.6 watch_a_movie(movie_id, user_id, time_period, likes, rating, shares)) The user "+user["name"].values.item() +" " +time_period+" the movie  " + movie_user_watched["name"].values.item()+ " and gives it a rating of " +str(rating) +".")
  ...
  #commented out for data-creation:
  #print("\n(F1.6 watch_a_movie(movie_id, user_id, time_period, likes, rating, shares)) This is the updated data:\n")
  #print(movie_user_watched[["name","rate","likes","shares","views"]])
...
def recommend_by_searched_term(searched_term):
    ...
    searched_term = searched_term.title()
...
def advanced_recommend_by_searched_term(searched_term, user):
  ...
  #extract the user
  chosen_user = users_df[users_df["name"] == user.lower()]
  ...
  while (a < len(watched_movie_ids_df.columns)):
    ...
    ids = int(watched_movie_ids_df[a][0])
  ...
  #The movie with the highest word_count gets printed out
  max_word_df = final_result.loc[final_result['word_count'].idxmax()]
  print("\n(F2.3 recommend_by_searched_term(searched_term)) You should watch "+ max_word_df["name"] + " because the searched_term " + searched_term +" appeard " + str(max_word_df["word_count"]) + " times:\n")
  print("\nHere you can find more information:\n")
  print(max_word_df[["name","genre","synopsis","rate","likes","shares","views"]])
...
advanced_recommend_by_searched_term("wrong", "tassilo")
...
def recommend_by_most_user_likes_in_genre(user_id):
  ...
  print()
  print("\n(F3.4. recommend_by_most_liked_in_genre(genre)) Here are the 5 most liked movies of the genre " + genre.values.item() + ":\n")
...
print("\n(F3.2. recommend_by_most_liked_in_genre(genre)) Please type in your favorite genre:\n")
...
recommend_by_most_user_likes_in_genre(0)
recommend_by_most_user_likes_in_genre(1)
...
def show_viewed_movies_by_time(time_period):
 ...
 if time_period.lower() == "total":
  ...
  print("\n(F5.4 show_viewed_by_time(time_period)) The 5 most viewed movies of all times are:\n")
  print (results_df)
  ...
  print("\n(F5.4 show_viewed_by_time(time_period)) The 5 most viewed movies of today are:\n")
  print (results_df)
  ...
  print("\n(F5.4 show_viewed_by_time(time_period)) The 5 most viewed movies of this week are:\n")
  print (results_df)
  ...
  print("\n(F5.4 show_viewed_by_time(time_period)) The 5 most viewed movies of this month are:\n")
  print (results_df)
  ...
  print("\n(F5.4 show_viewed_by_time(time_period)) The 5 most viewed movies of this year are:\n")
  print (results_df)
...
def recommend_for_user_by_last_movie_watched(user):
    ...
    #extract the user
    chosen_user = users_df[users_df["name"] == user]
    ...
    print("\n(F5.5) Here is the genre of the last movie the user watched:\n")
...
def share_a_movie(movie_id):
  ...
  #print out the result
  print("\n(F6.3 share_a_movie(movie_id, user_id)) These are the updated data: \n")
  print(movie_user_watched[["name","rate","likes","shares","views"]])
...
def show_shared_movies_by_time(time_period):
 ...
 if time_period.lower() == "total":
  ...
  print("\n(F6.4 show_shared_by_time(time_period)) The 5 most shared movies of all times are:\n")
  print (results_df)
  ...
  print("\n(F6.4 show_shared_by_time(time_period)) The 5 most shared movies of today are:\n")
  print (results_df)
  ...
  print("\n(F6.4 show_shared_by_time(time_period)) The 5 most shared movies of this week are:\n")
  print (results_df)
  ...
  print("\n(F6.4 show_shared_by_time(time_period)) The 5 most shared movies of this month are:\n")
  print (results_df)
  ...
  print("\n(F6.4 show_shared_by_time(time_period)) The 5 most shared movies of this year are:\n")
  print (results_df)
